...
<body>
	...
	<form action="prosesAddKriteria.php" method="POST" enctype="multipart/form-data">
		<!-- <div class="col-md-6"> -->
				<div class="panel panel-default ">					
					<div class="panel-body timeline-container">
								...
								<div class="form-group">
									<label>Bobot</label>
									<input name="bobot" class="form-control" onkeypress="return Angkasaja(event)" placeholder="Usia"required oninvalid="this.setCustomValidity('data tidak boleh kosong')" oninput="setCustomValidity">
								</div>
