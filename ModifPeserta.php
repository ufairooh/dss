...
<body>
	...
	<form action="prosesModifPeserta.php" method="POST" enctype="multipart/form-data">
		<!-- <div class="col-md-6"> -->
				<div class="panel panel-default ">					
					<div class="panel-body timeline-container">
						<!-- <form role="form" method="post" action="toFrom.php"> -->
								<div class="form-group">
									<input type="hidden" name="idContent" value="<?php echo $siswa['no_peserta'] ?>">
									<label>Nama</label>
									<input name="nama" class="form-control" placeholder="Judul" value="<?php echo $siswa['nama_peserta'] ?>" data-rule="required" data-msg="Judul tidak boleh kosong">
								</div>
								<div class="form-group" style="width: 300px;">
									...
									<div class="form-group" style="margin-top: 15px; width: 300px;">
										...
										<label>Tanggal Lahir</label>
  										<input id="getdate" name="ttl" class="form-control" type="text" placeholder="Masukan tanggal" value="<?php echo $siswa['tgl_lahir'] ?>" data-rule="required" data-msg="Pilih tanggal mulai donasi"/>
									
								</div>
								<div class="form-group">
									<label>Pekerjaan</label>
									<input name="pekerjaan" class="form-control" placeholder="Nama Pengaju" value="<?php echo $siswa['pekerjaan'] ?>" data-rule="required" data-msg="Nama pengaju tidak boleh kosong">
								</div>
								<div class="form-group">
									<label>Usia</label>
									<input name="usia" class="form-control" onkeypress="return Angkasaja(event)" placeholder="Jumlah Total Donasi" value="<?php echo $siswa['usia'] ?>" data-rule="required" data-msg="Jumlah donasi tidak boleh kosong">
								</div>
